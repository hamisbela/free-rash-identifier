...
import { Mail, MessageSquare, Stethoscope } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Have questions about our rash identifier? Need help understanding an analysis? 
              ...
              <div className="mt-8 p-4 bg-red-50 rounded-lg">
                <h3 className="text-red-800 font-semibold mb-2">⚠️ Important Medical Notice</h3>
                <p className="text-red-700 text-sm">
                  If you're experiencing severe symptoms, spreading rash, fever, or other concerning symptoms,
                  please seek immediate medical attention. This tool is for educational purposes only and
